...
scutum.$body = $("body"), scutum.$html = $("html"), scutum.$doc = $(document), scutum.$win = $(window), scutum.$sidebarMain = $("#sc-sidebar-main"), scutum.$offcanvas = $("#sc-offcanvas"), scutum.$toolbar = $("#sc-toolbar"), scutum.$header = $("#sc-header"), scutum.$topBar = $("#sc-page-top-bar"), scutum.$pageContent = $("#sc-page-content"), scutum.$pageWrapper = $("#sc-page-wrapper"), scutum.easingSwiftOut = [.55, 0, .1, 1], scutum.forms = {}, scutum.pages = {}, scutum.plugins = {}, scutum.components = {}, scutum.init = function() {
    ...
    return Object.keys(scutum.bundles).forEach(function(s) {
        ...
        return -1 !== s.indexOf("node_modules")
    })), e.push("node_modules/tinymce/**/*"), e
    ...
    scutum.$body.on("click", 'a[href="#"]', function(s) {
        s.preventDefault()
    })
    ...
    toggleListItems: function() {
        ...
        s.length && s.each(function() {
            ...
            e.on("ifChecked", function() {
                scutum.$body.find(t).iCheck("check")
            }).on("ifUnchecked", function() {
                scutum.$body.find(t).iCheck("uncheck")
            }), scutum.$body.on("ifChanged", t, function() {
                var s = !0;
                scutum.$body.find(t).each(function() {
                    $(this).is(":checked") || (s = !1)
    ...
    remove: function(s, e) {
        var t = (s ? $(s) : scutum.$body).find(".sc-overlay");
    ...
    scutum.$body.on("click", ".sc-js-card-close", function(s) {
        s.preventDefault();
        var e = $(this),
            t = e.closest(".uk-card"),
    ...
    init: function(s, m, p, h) {
        ...
        e.length && (e.each(function() {
            ...
            }), scutum.$body.on("click", "#" + t + " span", function() {
    ...
    (void 0 === s ? $("[data-sc-input]") : $(s).find("[data-sc-input]")).each(function() {
        ...
        scutum.$body.on("focus", "[data-sc-input]", function() {
