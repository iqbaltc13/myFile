					...
					<div id="sc-login-form" class="sc-toggle-login-register sc-toggle-login-password">
						...
						<div class="sc-login-page-inner">
							<div class="uk-margin-medium">
                                ...
                                <input id="email" type="email" class="uk-input" data-sc-input name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                @error('email')
                            ...
                            <div class="uk-margin-large-top">
                                <button type="submit" class="sc-button sc-button-large sc-button-block sc-button-danger">Login </button>
                        </form>
								<div class="uk-margin-large-top uk-text-center">
                                    <span class="sc-color-secondary">Don't have an account?</span>
                                    <div><a href="{{ route('register') }}" class="sc-text-semibold" >Register</a></div>
                                </div>
							</div>
						</div>
					</div>
